...
modelo_params = {
    "Predicción de cargo por tráfico": ["Zona de inicio", "Zona de finalización", "Distancia estimada", "Tiempo estimado"],
...
def main():
    ...
    st.write("Selecciona un modelo con los parámetros correspondientes para la predicción (solo números enteros):")
